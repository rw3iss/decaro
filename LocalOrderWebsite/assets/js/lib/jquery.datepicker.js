(function ($) {
  ...
  var Datepicker = (function () {
    ...
    function Datepicker(element, options) {
      ...
      this.elements[1]['children'][0] = { tag: 'a', class: 'dec', onclick: function () { _this.incrementMonth(-1, true); return false; } };
      this.elements[1]['children'][1] = { tag: 'a', class: 'inc', onclick: function () { _this.incrementMonth(1, true); return false; } }
    ...
    Datepicker.prototype.incrementMonth = function (amount, suppressCallback) {
      ...
      var suppressCallback = suppressCallback || false;

      return this.setSelectedDate(newDate, suppressCallback);
    };
